...
UGASGA_FireGun::UGASGA_FireGun()
{
	...
	FGameplayTag Ability1Tag = FGameplayTag::RequestGameplayTag(FName("Ability.Ability1"));
	AbilityTags.AddTag(Ability1Tag);
	ActivationOwnedTags.AddTag(Ability1Tag);

	ActivationBlockedTags.AddTag(FGameplayTag::RequestGameplayTag(FName("Ability.Blocked")));
